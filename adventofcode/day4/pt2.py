...
with open("adventofcode/day4/file.txt", 'r') as file:
    for line in file:
        ...
        #if count == 2:
        #    break
ticket_multiplier = [1]*len(lottery_ticket.keys())
#print(ticket_multiplier)
for key in lottery_ticket:
    index = int(key)
    wins = lottery_ticket[key][0]
    while wins > 0:
        multiple = ticket_multiplier[index-1]
        ticket_multiplier[index+wins-1] += multiple
        wins -= 1
for number in ticket_multiplier:
